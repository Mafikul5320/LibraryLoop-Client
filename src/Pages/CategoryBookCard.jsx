    ...
    return (
        ...
        >
            <div className='relative'>
                ...
                <span className='bg-gray-200 absolute top-3 left-3 px-3 py-1 flex items-center space-x-1.5 rounded-2xl'>
                    <Tag size={17} />
                    <span className='text-xs pb-0.5'>{category}</span>
                </span>
                <span className='bg-green-100 text-green-700 absolute top-3 right-3 px-3 py-1 flex items-center space-x-1.5 rounded-2xl'>
                    <Package size={17} />
                    <span className='text-xs font-bold pb-0.5'>{quantity}</span>
                </span>
            </div>
            <div>
                ...
                <div className='justify-center py-3 px-3'>
                    <Link
                        to={`/view-details/${_id}`}
                        className='btn py-6 bg-gradient-to-r from-blue-600 to-teal-600 text-white rounded-lg font-semibold text-base w-full'
                    >
                        <Eye size={17} />
                        View Details
                    </Link>
