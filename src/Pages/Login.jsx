        ...
        <div className='max-w-xl w-full mx-auto px-4 py-6 sm:px-6 lg:px-8'>
            ...
            <div className='my-8'>
                <form onSubmit={handleSubmit} className='space-y-3'>
                    ...
                    />
                    <button
                        className='btn h-11 mb-6 bg-gradient-to-r from-blue-600 to-teal-600 text-white rounded-full w-full'
                        type='submit'
                    >
                        Login
                    </button>
                ...
                <button
                    ...
                    className="btn my-3 h-11 rounded-full w-full bg-white text-black border-[#362478]"
                >
